...
def load_split_name_to_X_and_y(emulator: Emulator, X_train: ndarray,
                               y_train: ndarray,
                               X_test: Optional[ndarray]=None,
                               y_test: Optional[ndarray]=None,
                               years_train: Optional[ndarray]=None,
                               years_test: Optional[ndarray]=None,
                               validation_mask: Optional[ndarray]=None) \
...
def load_split_name_to_X_and_y_and_y_predicted_and_years(emulator: Emulator, X_train: ndarray,
                                                         y_train: ndarray,
                                                         X_test: Optional[ndarray]=None,
                                                         y_test: Optional[ndarray]=None,
                                                         years_train: Optional[ndarray]=None, years_test: Optional[ndarray]=None,
                                                         validation_mask: Optional[ndarray]=None) \
        -> dict[str, tuple[ndarray, ndarray, ndarray, ndarray]]:
...
def get_ymin_and_ymax(split_name_to_X_and_y_and_y_predicted_and_years: dict[str, tuple[ndarray, ndarray, ndarray, ndarray]]) -> tuple[float, float]:
    y_arrays = []
