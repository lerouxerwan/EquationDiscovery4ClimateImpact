...
def plot_errors_climato(emulator: PySREmulator, X_train: np.ndarray | pd.DataFrame,
    ...
    rcp_name_to_list_of_years_and_errors_and_color_and_label = load_rcp_name_to_list_of_years_and_y_and_color_and_label(errors_train, errors_test, years_train, years_test, rcp_name_train, rcp_name_test, nb_historical_years)
