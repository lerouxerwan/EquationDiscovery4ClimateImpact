...
def get_filepath_search(X_sum: float, y_sum: float, validation_size: float, search_cv_type: type, n_iter: int,
                        param_grid: dict, feature_selection_name: str, select_k_features: Optional[int], **params_fit) -> str:
    ...
    filename_search += f'_{feature_selection_name}_{select_k_features}_{NB_THRESHOLDS}'
