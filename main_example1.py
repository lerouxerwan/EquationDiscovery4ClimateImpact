...
def main():
    ...
    print(dataset.X_train.sum())
    print(dataset.y_train.sum())
    print(dataset.X_test.sum())
    print(dataset.y_test.sum())
    params = {'model_selection': 'validated', 'adaptive_parsimony_scaling': np.float64(816.4197141003457), 'alpha': 3.17,
