from data.load_goy_simu_dat import split_name_to_goy_label_name, simu_id_to_rcp_name
from data.utils_dataset.dataset import Dataset
from data.utils_dataset.validation_split import get_train_label, get_validation_label, ValidationSplit
...
def get_label_split_name(split_name: str, dataset: Dataset) -> str:
    ...
    is_goy_dataset = dataset.rcp_name_test == simu_id_to_rcp_name[3]
    if is_goy_dataset:
        return label + split_name_to_goy_label_name[split_name]
    else:
