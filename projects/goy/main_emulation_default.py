...
def main_emulation_default(nb_variables: int, with_validation: bool, validation_size: float = 0.3):
    dataset = get_goy_dataset(nb_variables, with_validation, validation_size)
    # Par default le batchsize est de 50, mais je test aussi 100 (et niterations =100 ou 200 ou 1000)
    emulator = Emulator(batching=True, niterations=1, batch_size=50)
...
if __name__ == '__main__':
    main_emulation_default(nb_variables=10, with_validation=True)
