...
def test_load_dataset(load_dataset_function):
    ...
    X_train, y_train, X_test, y_test, X_units, y_units, years_train, years_test, rcp_name_train, rcp_name_test, _, _, ind_validation = load_dataset_function(filename_dataset)
