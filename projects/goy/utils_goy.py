...
def get_goy_dataset_without_validation(nb_variables: int) -> Dataset:
    csv_filepath = get_filepath_dataset_csv(nb_variables, with_validation=False)
...
if __name__ == '__main__':
    get_goy_dataset_without_validation(nb_variables=10)
