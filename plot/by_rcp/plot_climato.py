...
from plot.by_rcp.plot_time_series_climato import plot_climatological_time_series
...
from plot.by_split.utlis_plot_selected_equation import get_true_label_and_predicted_label, \
    uncapitalize, get_label, get_true_and_predicted_label
...
def _plot_errors_climato(emulator: Emulator, dataset: Dataset, show: Optional[bool] = False, relative_error: bool = False,
    ...
    rcp_name_to_list_of_years_and_errors_and_color_and_label = load_rcp_name_to_list_of_years_and_y_and_color_and_label(errors_train, errors_test, dataset.years_train, dataset.years_test,
                                                                                                                        dataset.rcp_name_train, dataset.rcp_name_test, dataset.nb_historical_years)
