...
def plot_selected_features_top_equations(dataset: Dataset, experiment: Experiment,
    ...
    if len(df) >= nb_top_equations:
        ...
        all_feature_indexes = []
        for selected_feature_indexes in df[experiment.feature_indexes_column_name].values[:nb_top_equations]:
        ...
        for selected_feature_index in experiment.df_cv_results[experiment.feature_indexes_column_name].values[0]:
...
def plot_selected_features_best_equation(dataset: Dataset, experiment: Experiment, show: bool = False,
    ...
    selected_feature_indexes = experiment.df_cv_results[experiment.feature_indexes_column_name].values[0]
