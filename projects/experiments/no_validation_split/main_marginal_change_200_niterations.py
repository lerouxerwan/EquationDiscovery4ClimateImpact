...
def main_run_marginal_change_niterations():
    workflow(dataset_npp_season_no_validation_split, {'niterations':200})

def main_run_marginal_change_warmup_maxsize_by():
    workflow(dataset_npp_season_no_validation_split, {'warmup_maxsize_by':0.5, 'niterations':200})

def main_run_marginal_change_sqrt():
    workflow(dataset_npp_season_no_validation_split, {'unary_operators':['sqrt'], 'niterations':200})

def main_run_marginal_change_log():
    workflow(dataset_npp_season_no_validation_split, {'unary_operators':['log'], 'niterations':200})
